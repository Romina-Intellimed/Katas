...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        new ToDoParticipant(name: "James Sawyer",emailAddress:  "james.sawyer@gmail.com",age: 22)
        new ToDoParticipant(name: "Billy Blancs",emailAddress:  "billy.blancs@yahoo.com",age: 32)
    }
    def destroy = {
    }
}
