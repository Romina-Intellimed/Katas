...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def item1 = new ToDoItem(name: "Learn Grails", description: "Read and practice", participant: ToDoParticipant.findByName("Jake Bond"), startDate: new Date(), endDate: new Date(), remindDate: new Date(), location: "Mozaik", priority: PriorityType.HIGH, repeat: true).save(failOnError: true)
        def item2 = new ToDoItem(name: "Learn Groovy", description: "Read and practice", participant: ToDoParticipant.findByName("Billy Blancs"), startDate: new Date(), endDate: new Date(), remindDate: new Date(), location: "Mozaik", priority: PriorityType.HIGH, repeat: true).save(failOnError: true)
